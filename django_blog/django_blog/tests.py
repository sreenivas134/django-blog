...
from django_blog.django_blog.models import Category, Post, Tags, PostHistory, UserRole, Page
from django.contrib.auth.models import User
from django_blog.django_blog.forms import BlogCategoryForm, BlogPostForm, AdminLoginForm
from django.core.urlresolvers import reverse
from django_blog.django_blog.models import Menu, Theme
...
#         upload_file = open('/django_blog/static/favicon.png', 'rb')
