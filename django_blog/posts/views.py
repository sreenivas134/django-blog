...
from django_blog.django_blog.models import Post, Category, Tags, Page
from django_blog.django_blog.forms import ContactForm
...
from django_blog.django_blog.models import ContactUsSettings, Post_Slugs
...
class BlogPostView(DetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context.update({
            ...
            "og_image": self.object.featured_image.url if self.object.featured_image else ''
        })
        context.update(categories_tags_lists())
        return context
