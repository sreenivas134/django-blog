"""
Django settings for aitechcentral project.
...
MIDDLEWARE = [
    ...
    'aitechcentral.centralMiddleware.HitCountMiddleWare',
]

ROOT_URLCONF = 'aitechcentral.urls'
...
WSGI_APPLICATION = 'aitechcentral.wsgi.application'
